<script lang="ts">
  ...
  function getIcon(id: ActiveTool): string {
    switch (id) {
      case "select":
        // Cursor/arrow icon
        return "m3.84227,1.05363l-0.15773,15.1041l3.61987,-4l2.20032,5.84227l2.07886,-1.05363c-0.94374,-1.92955 -1.25657,-3.38591 -2.20032,-5.31546l4.8817,0l-10.42271,-10.57729z";
      case "addNode":
        // Plus icon
